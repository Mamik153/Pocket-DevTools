...
export function HeroDeveloperIllustration({ className = "w-full max-w-sm h-auto" }: { className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="70" cy="60" r="4" fill="#38BDF8" opacity="0.9" />
      <circle cx="340" cy="80" r="6" fill="#2563EB" opacity="0.85" />
      <circle cx="320" cy="240" r="5" fill="#7C3AED" opacity="0.85" />
      <circle cx="50" cy="220" r="4" fill="#A855F7" opacity="0.8" />

      {/* Main IDE Window */}
      <g transform="translate(75, 45)">
        {/* Window Shadow & Frame */}
        <rect x="0" y="0" width="250" height="175" rx="16" fill="#FFFFFF" fillOpacity="0.92" stroke="#E2E8F0" strokeWidth="2" />
        {/* Window Titlebar */}
        ...
        <circle cx="36" cy="16" r="5" fill="#FBBF24" />
        ...
        <rect x="20" y="130" width="160" height="8" rx="4" fill="#0284C7" opacity="0.6" />
      ...
      <g transform="translate(45, 120)">
        ...
        <path d="M22 20C20 20 18 22 18 24V26C18 27.5 17 28 16 28C17 28 18 28.5 18 30V32C18 34 20 36 22 36" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M34 20C36 20 38 22 38 24V26C38 27.5 39 28 40 28C39 28 38 28.5 38 30V32C38 34 36 36 34 36" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      </g>
      ...
      <g transform="translate(290, 140)">
        ...
        <path d="M20 42V18L28 26L36 18V42" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M40 32L40 42M40 42L36 38M40 42L44 38" stroke="#7C3AED" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </g>

      {/* Floating Gear / Shield Badge 3 */}
      <g transform="translate(260, 30)">
        <rect x="0" y="0" width="48" height="48" rx="12" fill="#FFFFFF" stroke="url(#hero-grad-3)" strokeWidth="2" />
        <path d="M24 14L32 18V25C32 30 28 34 24 36C20 34 16 30 16 25V18L24 14Z" fill="url(#hero-grad-3)" opacity="0.3" stroke="#7C3AED" strokeWidth="2" />
      </g>
    </svg>
  );
}
...
export function EmptyStateIllustration({ className = "w-48 h-48 mx-auto" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <circle cx="100" cy="100" r="70" fill="#2563EB" fillOpacity="0.08" />
      <path
